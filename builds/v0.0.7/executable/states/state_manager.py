...
class StateManager:
    def __init__(self, screen, clock):
        ...
        self.total_food_eaten = 0  # v0.0.7: Persistent food tracking
        self.obstacles = []
        self.game_speed = 10
        self.shield_timer = 0
        ...
        self.boss_wins = 0  # v0.0.7: Persistent boss win tracking
        ...
        # v0.0.7: Contextual hint tracking
        self.hints_shown = set()
        self.hint_timers = {}
        self.active_hints = []
        self.total_game_time = 0  # Ticks since game started
    ...
    def reset_game(self):
        ...
        # v0.0.7: Reset hints for new game
        self.active_hints = []
        self.hint_timers = {}
    ...
    def show_contextual_hint(self, hint_key, text, duration):
        """Show a contextual hint for first-time encounters."""
    ...
    def update(self):
        ...
        # v0.0.7: Update contextual hints
